...
class CommercialDecisionPresenter
{
    public function present(
        ...
        $lines[] =
            'Scope: Commercial decision guidance only. This surface does not prioritise candidates, perform reconciliation, alter canonical services, invoice or contact clients, execute or persist actions.';
